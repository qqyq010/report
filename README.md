...
| `projects/project2-coin-survivor/` | 팀 프로젝트 1 근거 정리 |
...
| Project2 | Coin Survivor / Inventory / Shop / UI / EventBus / 디버깅 / 검증 근거를 받을 예정입니다. 기존 `portfolio/02-coin-laundry/` 요약과 명칭/범위 관계를 확인해야 합니다. |
